...
(def lib 'org.clojars.greenlabs/spandex)
...
(defn- pom-template
  ...
  [[:description "Fork of com.cognitect/http-client that uses Jetty 11"]
   [:url "https://github.com/green-labs/spandex"]
   [:licenses
    [:license
   ...
   [:scm
    [:url "https://github.com/green-labs/spandex"]
    [:connection "scm:git:https://github.com/green-labs/spandex.git"]
    [:developerConnection "scm:git:ssh:git@github.com:green-labs/spandex.git"]
    [:tag (str "v" version)]]])
